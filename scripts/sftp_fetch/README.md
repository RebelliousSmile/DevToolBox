...
Ce script télécharge uniquement les fichiers déclarés dans un fichier YAML. Chaque
entrée doit désigner un fichier : les dossiers ne sont plus parcourus. Une entrée qui
pointe vers un répertoire distant est signalée en erreur.
...
Sans `--only`, toutes les entrées sont traitées.
